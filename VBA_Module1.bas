...
Sub Insert_columns()
    ...
    Call func_insert_column("2_ヤグラ勝率")
    Call func_insert_column("3_ホコ勝率")
...
Sub sort_stage()
    ...
    Call func_sort("2_ヤグラ勝率", "A", "As")
    Call func_sort("3_ホコ勝率", "A", "As")
...
Sub sort_stats()
    ...
    Call func_sort("2_ヤグラ勝率", "D", "Des")
    Call func_sort("3_ホコ勝率", "D", "Des")
